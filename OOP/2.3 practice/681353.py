...
print(emp.personal_data.display_person_info())

assert emp.work.company_name == 'Google'
assert emp.work.location == 'Atlanta'
print(emp.work.display_company_info())
...
print(emp2.personal_data.display_person_info())

assert emp2.work.company_name == 'Facebook'
assert emp2.work.location == 'Seattle'
print(emp2.work.display_company_info())